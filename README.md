...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/akismet-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15124&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/akismet-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `akismet` can be installed with:

```
conda install akismet
```

It is possible to list all of the versions of `akismet` available on your platform with:
